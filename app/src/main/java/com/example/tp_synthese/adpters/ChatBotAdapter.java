...
public class ChatBotAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case 0:
                view= LayoutInflater.from(context).inflate(com.example.tp_synthese.R.layout.usr_msg_item,parent,false);
                return new UserViewHolder(view);
            case 1:
                view= LayoutInflater.from(context).inflate(com.example.tp_synthese.R.layout.bot_msg_item,parent,false);
    ...
    static class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        public UserViewHolder(@NonNull View itemView) {
            super(itemView);
            this.tvMsgUsr =itemView.findViewById(com.example.tp_synthese.R.id.tvMsgUsr);
        }
    }
    static class BotViewHolder extends RecyclerView.ViewHolder{
        ...
        public BotViewHolder(@NonNull View itemView) {
            super(itemView);
            this.tvMsgBot =itemView.findViewById(com.example.tp_synthese.R.id.tvMsgBot);
        }
    }
}
